public class NumberOfDaysInMonth {
    public static void main(String[] args) {
        ...
        System.out.println("This year is LeapYear and this is -> " + result);

        int result1 = getDaysInMonth(2, 2024);
        System.out.println("This month has -> " + result1 + " days");
    }
    ...
    public static boolean isLeapYear(int year) {
        if (year < 1 || year > 9999) {
            System.out.println("Invalid value! Parameter should be (1; 9999).");
            return false;
        }
        if (year % 4 == 0) {
            if (year % 100 != 0) {
